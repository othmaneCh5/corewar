...
public class Instructions {
    ...
    public Instructions(Opecode opecode, int parametreA, int parametreB) {
        this(opecode, AddrMode.DIRECT, parametreA, AddrMode.DIRECT, parametreB);
    }
    ...
    public Instructions copy() {
        return new Instructions(this.opecode, this.modeA, this.parametreA, this.modeB, this.parametreB);
    }
